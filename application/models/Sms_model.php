...
class Sms_model extends CI_Model {
 ...
 public function get_users_by_category($category)
    {


            $this->db->select()->from('members AS m')->where('m.categry =',$category);
...
public function useHTTPGetBalance($url, $username, $apikey) {
